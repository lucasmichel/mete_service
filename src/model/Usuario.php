 ...
 */
	class Usuario {
		 ...
		 * @return Usuario
		 */		
		public function __construct($id = 0,Perfil $perfil = null,
                        $login = '',$senha = null,
                        $email = '',$dataUltimoLogin = null, $excluido = 0){
		...
		public static function listar(){
			...
			foreach($usuarios as $usuario){
				...
				$objetos[] = new Usuario($usuario['id'],Perfil::buscar($usuario['id_perfil']),
                                        $usuario['login'],
                                        $usuario['email'],
